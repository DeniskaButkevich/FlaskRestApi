...
from app.model.user import db, User as UserModel
...
class User(Resource):
    ...
    def put(self, id_user):
        ...
        video = UserModel(id=id_user, fullname=args['fullname'], username=args['username'], password=args['password'], email=args['email'])
